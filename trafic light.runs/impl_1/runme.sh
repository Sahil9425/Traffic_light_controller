...
HD_PWD='D:/trafic light/trafic light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traficlight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traficlight.tcl -notrace
