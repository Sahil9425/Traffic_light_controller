...
HD_PWD='D:/trafic light/trafic light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traficlight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traficlight.tcl
